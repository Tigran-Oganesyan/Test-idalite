...
var info = document.querySelector('.form-info');
...
function show() {
  ...
  arr.forEach(function (item) {
    show += "\n        <div class=\"card\">\n            <div class=\"delete\">\n                <img class=\"delete-icon\" src=\"./images/delete 1.png\"> \n            </div>\n            <img class=\"card-img\" src=\"".concat(item.img, "\">\n            <h2 class=\"card-title\">").concat(item.title, "</h2>\n            <p class=\"card-info\">").concat(item.info, "</p>\n            <p class=\"card-price\">").concat(item.price, " \u0440\u0443\u0431</p>\n        </div>\n        ");
...
//# sourceMappingURL=/new.e31bb0bc.js.map